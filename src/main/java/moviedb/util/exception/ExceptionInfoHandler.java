...
import moviedb.util.ValidationUtil;
...
import static moviedb.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    private static final Map<String, String> CONSTRAINS_I18N_MAP = Collections.unmodifiableMap(
            new HashMap<String, String>() {
                {
                    put("users_unique_login_idx", "exception.user.duplicateLogin");
                    put("movie_unique_name_idx", "exception.movie.duplicateName");
                    put("actors_unique_name_surname_idx", "exception.actor.duplicateNameSurname");
                    put("votes_idx", "exception.vote.duplicateUserMovie");
                }
            });

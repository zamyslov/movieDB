...
public class UserTestData {
    ...
    public static final User USER = new User(USER_ID, "User", "password", "User", Role.ROLE_USER);
    public static final User ADMIN = new User(ADMIN_ID, "Admin", "admin", "Admin", Role.ROLE_ADMIN, Role.ROLE_USER);
